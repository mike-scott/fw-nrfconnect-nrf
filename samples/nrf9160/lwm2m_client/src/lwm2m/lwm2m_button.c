...
#define LOG_MODULE_NAME app_lwm2m_button
...
int handle_button_events(struct ui_evt *evt)
{
	...
	switch (evt->button) {
		case UI_BUTTON_1:
			...
			lwm2m_engine_set_s32("3347/0/5518", timestamp);
			return 0;
		case UI_BUTTON_2:
			lwm2m_engine_set_bool("3347/1/5500", state);
			lwm2m_engine_set_s32("3347/1/5518", timestamp);
			return 0;
		case UI_SWITCH_1:
			lwm2m_engine_set_bool("3342/0/5500", state);
			lwm2m_engine_set_s32("3342/0/5518", timestamp);
			return 0;
		case UI_SWITCH_2:
			lwm2m_engine_set_bool("3342/1/5500", state);
			lwm2m_engine_set_s32("3342/1/5518", timestamp);
			return 0;
	}
